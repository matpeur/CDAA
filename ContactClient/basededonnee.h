...
public:
    ...
    std::list<toDo*> recherchelistetodopardate(int  idCONTACT,int idINTERAC,std::string,std::string);
    std::list<toDo*> recherchelistetodoparinterraction(int idCONTACT,int idINTERAC);
    std::list<toDo*> recherchelistetodo(std::string,std::string,int  idCONTACT,int idINTERAC,bool,bool);
